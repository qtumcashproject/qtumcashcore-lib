# Private Key
Represents a QTH private key and is needed to be able to spend QTH and sign transactions.
...
Note: The WIF (Wallet Import Format) includes information about the network and if the associated public key is compressed or uncompressed (thus the same QTH address will be generated by using this format).
